...
* Call set_defaults with the minimal of the following kwargs:
  ...
  Example:
    ...
    session.set_defaults(
        sql_connection="sqlite:///var/lib/dnrm/sqlite.db",
        sqlite_db="/var/lib/dnrm/sqlite.db")
...
from dnrm.openstack.common.db import exception
    ...
    def _do_query(self, q):
        ...
        for file, line, method, function in traceback.extract_stack():
            ...
            if file.endswith('db/api.py'):
                continue
            # only trace inside dnrm
            index = file.rfind('dnrm')
            if index == -1:
                continue
